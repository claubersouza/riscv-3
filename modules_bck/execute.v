...
begin
    ...
    begin
        ...
        pipe.wb_custom_addi2         <= 1'b0;
        pipe.wb_custom_addi2_base1   <= 32'd0;
        pipe.wb_custom_addi2_base2   <= 32'd0;
    ...
    begin
        ...
        pipe.wb_custom_addi2          <= pipe.custom_addi2;
        pipe.wb_custom_addi2_base1    <= pipe.reg_rdata1;
        pipe.wb_custom_addi2_base2    <= pipe.reg_rdata2;

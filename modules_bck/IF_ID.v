...
begin
    ...
    pipe.custom_lw2b            <= (pipe.instruction == 32'h06f47053);
    ...
    pipe.custom_addi2          <= (pipe.instruction == 32'h02055e53);
...
//00400513  // addi x10, x0, 4
    ...
    // Forwarding da CUSTOM_ADDI2 02055e53.
    (pipe.wb_custom_addi2 &&
     pipe.src1_select == 5'd28) ?
        (pipe.wb_custom_addi2_base1 +
         32'sd0) :
    (pipe.wb_custom_addi2 &&
     pipe.src1_select == 5'd10) ?
        (pipe.wb_custom_addi2_base2 +
         32'sd4) :
...
assign pipe.reg_rdata2 =
    ...
    // Forwarding src2 da CUSTOM_ADDI2 02055e53.
    (pipe.wb_custom_addi2 &&
     pipe.src2_select == 5'd28) ?
        (pipe.wb_custom_addi2_base1 +
         32'sd0) :
    (pipe.wb_custom_addi2 &&
     pipe.src2_select == 5'd10) ?
        (pipe.wb_custom_addi2_base2 +
         32'sd4) :
...
else if (pipe.wb_custom_addi2 &&
         !pipe.stall_read &&
         !pipe.wb_stall)
begin
    pipe.regs[28] <=
        pipe.wb_custom_addi2_base1 + 32'sd0;
    pipe.regs[10] <=
        pipe.wb_custom_addi2_base2 + 32'sd4;
end
